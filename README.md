# algorithm
---
## 作者：贺大帅批（题目均来自leetcode）
下面整理了一些题单

- 首先是数学算法吧，感觉没学编程的也可以理解

> 预处理质数（筛质数）
[计数质数](https://leetcode.cn/problems/count-primes/description/)
[根据质数下标分割数组](https://leetcode.cn/problems/split-array-by-prime-indices/description/)
[检查元素频次是否为质数](https://leetcode.cn/problems/check-if-any-element-has-prime-frequency/description/)
[和等于目标值的质数对](https://leetcode.cn/problems/prime-pairs-with-target-sum/description/)
[统计不是特殊数字的数字数量](https://leetcode.cn/problems/find-the-count-of-numbers-which-are-not-special/description/)
[范围内最接近的两个质数](https://leetcode.cn/problems/closest-prime-numbers-in-range/description/)

> 质因数分解
[数组乘积中的不同质因数数目](https://leetcode.cn/problems/distinct-prime-factors-of-product-of-array/description/)
[使用质因数之和替换后可以取到的最小值](https://leetcode.cn/problems/smallest-value-after-replacing-with-sum-of-prime-factors/description/)
[使数组非递减的最少除法操作次数](https://leetcode.cn/problems/minimum-division-operations-to-make-array-non-decreasing/description/)
[分割数组使乘积互质](https://leetcode.cn/problems/split-the-array-to-make-coprime-products/description/)
[最大公约数遍历](https://leetcode.cn/problems/greatest-common-divisor-traversal/description/)
[数组的最大公因数排序](https://leetcode.cn/problems/gcd-sort-of-an-array/description/)

> 因子
[公因子的数目](https://leetcode.cn/problems/number-of-common-factors/description/)
...
[字符串的最大公因子](https://leetcode.cn/problems/greatest-common-divisor-of-strings/description/)
[使数组可以被整除的最少删除次数](https://leetcode.cn/problems/minimum-deletions-to-make-array-divisible/description/)
[水壶问题](https://leetcode.cn/problems/water-jug-problem/description/)
[检查「好数组」](https://leetcode.cn/problems/check-if-it-is-a-good-array/description/)

> 同余与数论分块
[摧毁一系列目标](https://leetcode.cn/problems/destroy-sequential-targets/description/)
[执行操作后的最大 MEX](https://leetcode.cn/problems/maximum-mex-after-applying-operations/description/)
[使数组和能被 P 整除](https://leetcode.cn/problems/make-sum-divisible-by-p/description/)
[可被 5 整除的二进制前缀](https://leetcode.cn/problems/binary-prefix-divisible-by-5/description/)
[将整数按权重排序](https://leetcode.cn/problems/sort-integers-by-the-power-value/description/)
[可被 K 整除的最小整数](https://leetcode.cn/problems/smallest-integer-divisible-by-k/description/)

> 组合数学 - 乘法原理
[直角三角形](https://leetcode.cn/problems/right-triangles/description/)
[分割字符串的方案数](https://leetcode.cn/problems/number-of-ways-to-split-a-string/description/)
[统计无向图中无法互相到达点对数](https://leetcode.cn/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph/description/)
[猴子碰撞的方法数](https://leetcode.cn/problems/count-collisions-of-monkeys-on-a-polygon/description/)
[统计好数字的数目](https://leetcode.cn/problems/count-good-numbers/description/)
[分隔长廊的方案数](https://leetcode.cn/problems/number-of-ways-to-divide-a-long-corridor/description/)

> 组合计数
[不同路径](https://leetcode.cn/problems/unique-paths/description/)
[统计各位数字都不同的数字个数](https://leetcode.cn/problems/count-numbers-with-unique-digits/description/)
[质数排列](https://leetcode.cn/problems/prime-arrangements/description/)
[有效的快递序列数目](https://leetcode.cn/problems/count-all-valid-pickup-and-delivery-options/description/)
[恰好移动 k 步到达某一位置的方法数目](https://leetcode.cn/problems/number-of-ways-to-reach-a-position-after-exactly-k-steps/description/)
...
[3710. 最大划分因子](https://leetcode.cn/problems/maximum-partition-factor/description/)
...
> 第 K 小/大
[668. 乘法表中第K小的数](https://leetcode.cn/problems/kth-smallest-number-in-multiplication-table/description/)
...
[1201. 丑数 III](https://leetcode.cn/problems/ugly-number-iii/description/)
...
- 滑动窗口与双指针算法，核心在于维护区间的单调性与指针的相对移动

> 基础定长滑动窗口（维护固定大小的窗口状态）
...
[3795. 不同元素和至少为 K 的最短子数组长度](https://leetcode.cn/problems/shortest-subarray-with-sum-at-least-k/description/)

> 不定长滑窗 - 方案统计（越长/越短越合法 & 恰好型计数）
...
- DFS 与 BFS 算法：核心在于遍历策略的不同。DFS 擅长深入探索与回溯（如求所有方案、连通块），BFS 擅长层级推演与最短路（如求最少步数、多源扩散）。

> 专项一：树的深度优先搜索 (Tree DFS - 自底向上与自顶向下)
...
> 专项三：网格图的 DFS (Grid DFS - 岛屿模型与回溯搜索)
...
> 专项四：网格图的 BFS (Grid BFS - 最短路径与多源扩散)
...
> 专项五：一般图论 DFS (Graph DFS - 连通性与环检测)
...
> 专项六：状态空间 BFS 与拓扑排序 (State BFS & Topo Sort)
